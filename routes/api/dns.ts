...
const QUERIES_TO_RUN: Array<{ subdomain: string; types: RecordType[] }> = [
  ...
  // DKIM selectors
  { subdomain: "api._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "cf2024-1._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "cm._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "default._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "dk._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "dkim._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "google._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "k1._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "k2._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "k3._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "krs._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "m1._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "mail._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "mailjet._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "mailo._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "mailru._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "mandrill._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "ml._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "mx._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "pic._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "resend._domainkey", types: ["TXT", "CNAME"] },
  ...
  { subdomain: "smtpapi._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "smtp._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "titan1._domainkey", types: ["TXT", "CNAME"] },
  ...
  { subdomain: "x._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "zmail._domainkey", types: ["TXT", "CNAME"] },
  { subdomain: "zoho._domainkey", types: ["TXT", "CNAME"] },
